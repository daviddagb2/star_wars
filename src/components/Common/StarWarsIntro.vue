<template>
  <div class="sw_intro" ref="swintro">
    <section class="intro">
      A long time ago, in a galaxy far,<br />
      far away....
    </section>

    <section class="logostarwars">
      <svg
        version="1.0"
        id="Layer_1"
...
.sw_intro {
  ...
  /* Set the animation & hide the logostarwars */
  .logostarwars {
    position: absolute;
    //top: 50%;
    //left: 30%;
    z-index: 1;
    animation: logostarwars 9s ease-out 9s;
    color: rgb(75, 213, 238);
    font-weight: 400;
    font-size: 269%;
    opacity: 0;
  ...
  /* Scale the logostarwars down and maintain it centered */
...
export default {
  ...
  setup() {
    ...
    for (let i = 0; i < numStars; i++) {
      ...
      //document.getElementsByClassName("sw_intro").append(star);
      //document.getElementsByClassName("sw_intro")[0].append(star);
    }
